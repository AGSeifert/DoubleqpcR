...
system.file("extdata", "rps4_8fach_cq.csv", package = "DoubleqpcR")
system.file("extdata", "rps4_8fach.csv", package = "DoubleqpcR")
```
...
regression.delta.Cq(CqType = "Regression", fit = "poly3", cv = TRUE)
```
